...
<section class="food-menu">
    <div class="container">
        ...
        <?php 
            ...
            //CHeck whether products is available or not
            if($count2>0)
            {
                        ...
                        <div class="food-menu-img">
                            <?php 
                                ...
                                else
                                {
                                    //Image Available
                                    ?>
                                    <img src="<?php echo SITEURL; ?>images/products/<?php echo $image_name; ?>" alt="image not found" class="img-responsive img-curve">
                                    <?php
                                }
                            ?>
